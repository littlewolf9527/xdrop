...
type Handlers struct {
	...
	blacklistB goebpf.Map // shadow blacklist (Phase 4.2 dual rule map)
	whitelist  goebpf.Map
	stats      goebpf.Map
	rlStates   goebpf.Map

	// Double-buffer config maps
	configA      goebpf.Map // config_a
	configB      goebpf.Map // config_b
	activeConfig goebpf.Map // active_config selector
	...
	// === CIDR support ===
	cidrBlacklist  goebpf.Map
	cidrBlacklistB goebpf.Map // shadow CIDR blacklist (Phase 4.2 dual rule map)
	cidrRlStates   goebpf.Map
